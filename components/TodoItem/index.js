const { todoItemDoubleClick, todoItemOnToggleCompleted, todoItemOnEnter } = require('../../signals/todo');
const { removeTodo } = require('../../signals/form');
  ...
  bind () {
    return {
      dblclick: {
        ...
        '.view': () => {
          this.$context.signal(todoItemDoubleClick, {
            id: this.$context.attributes['cat-id']
          });
        }
      },
      ...
      click: {
         ...
         */
        '.toggle': () => {
          this.$context.signal(todoItemOnToggleCompleted, {
            id: this.$context.attributes['cat-id']
          });
        }
      },
